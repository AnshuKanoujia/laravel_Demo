...
@section('title') 
<title>Update Tour Booking </title>
<style type="text/css">
		#financial-details thead th{
		white-space: nowrap;
	}
  #financial-details select.selectpicker.form-control{
...
var passengers="{{$booking_deatils['tour_bookings_details']->passengers}}";
var tourId="{{$booking_deatils['tour_bookings_details']->id}}";
	...
	// {
            ...
            if(event.eventDetails)
              event.eventDetails.forEach(function(elem,index){
                console.log(elem)
                console.log(index)
                element.find('.fc-content').append('<span class="event_labels" >'+ elem.label +'</span>');
            })
						...
						element.find(".open-modal").on("click", function(e) {
                            ...
                            var edit_tour_id="{{$booking_deatils['tour_bookings_details']->id}}";
							var edit_passnger="{{$booking_deatils['tour_bookings_details']->passengers}}";
							var passenger= $('#passengers').val()?$('#passengers').val():edit_passnger;
							var tour_id= tourId?tourId:edit_tour_id; 
							// alert('Passenger id: '+passenger+' Tour id '+tour_id); 
