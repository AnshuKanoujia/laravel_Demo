                    ...
                    {{ csrf_field() }}
                      ...
                      <div class="box-body clearfix">
                        ...
                        <div class="row CurrencyTypeBox">
                          <div class="col">
                            <div class="form-group">
                              <label for="groupCurrencyType">Select Currency</label>
                              <select name="groupCurrencyType" id="groupCurrencyType" class="form-control" onchange="updteCurrentType(event)">
                      ...
                      <div class="box-body clearfix">
                        ...
                        <div class="row CurrencyTypeBox">
                          <div class="col">
                            <div class="form-group">
                              <label for="paxCurrrencyType">Select Currency</label>
                              <select class="form-control" id="paxCurrrencyType" onchange="updteCurrentType(event)" name="paxCurrrencyType">
                                <option value="">Select Currency</option>
                                <option value="IDR">IDR</option>
                                <option value="INR">INR</option>
                                <option value="EUR">EUR</option>
...
.on('click','.btn-next',function(e){
  ...
  if($(this).hasClass('step-1'))
  {
    ...
    stepOneAllFieldsVals['groupCurrencyType']=$("input[name='groupCurrencyType']").val();
    stepOneAllFieldsVals['paxCurrrencyType']=$("input[name='paxCurrrencyType']").val();
