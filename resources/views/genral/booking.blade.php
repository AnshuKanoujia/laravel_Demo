								   ...
								   <div class="col-md-12 text-danger"><label>Note:-</label>All  * fields  are required...</div>
									<div class="col-md-6">
									   ...
									   <div class="form-group">
										  ...
										  <input type="text" class="form-control" required  maxlength="20" onkeypress="return restrictNumerics(event);"  id="guest_name"  name="guest_name" placeholder="Guest Name">
									   </div>
									   @if($booking_deatils['bookingtype']=='tour')
									   <div class="form-group">
										  <label for="arrival_flight_no"> Arrival Flight</label>
									   ...
									   <div class="form-group">
										  <label for="departure_flight_no"> Departure Flight </label>
									   ...
									   <div class="form-group">
										  ...
										  <input type="text" class="form-control" maxlength="10" onkeypress="return restrictAlphabets(event);" required id="guest_whatsapp"  name="guest_whatsapp" placeholder="Guest Whatsapp">
									   </div>
									   ...
									   <div class="row">
										  <div class="col-md-4">
											 ...
											 <div class="form-group">
												...
												<input type="text" class="form-control"  maxlength="20" required id="passengers"  onkeypress="return restrictAlphabets(event);" name="passengers" placeholder="No of passengers">
											 </div>
										  </div>
										  <div class="col-md-8">
											 @if($booking_deatils['bookingtype']=='tour')
											   ...
											   <div class="row">
												  <div class="col-md-6">
													  <div class="form-group">
														  ...
														  <input type="text" class="form-control"  maxlength="5" required  id="children_below_3" onkeypress="return restrictAlphabets(event);  " name="children_below_3" placeholder="below 3">
													  </div>
												  </div>
												  <div class="col-md-6">
													  <div class="form-group">
														  <label for="children_below_8">Children Below 8<i style="color:red; ">*</i></label>
														  <input type="text" class="form-control" maxlength="5" required  id="children_below_8" onkeypress="return restrictAlphabets(event);  " name="children_below_8" placeholder="Below 8">
													  </div>
												  </div>
											   </div>
   ...
   <div class="modal-dialog modal-sm">
	  <div class="modal-content">
		 ...
		 <div class="modal-body">
		  ...
		  <label class="mb-10"><input type="checkbox"> Email (<span class="new_guest_email"></span>) </label>
		  <label><input type="checkbox"> WhatsApp  (<span class="new_guest_whatsapp"></span>) </label>
...
<div class="modal fade" id="goback" role="dialog">
   <div class="modal-dialog modal-sm">
	  <div class="modal-content">
		 <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" style="color: lightgray !important;">&times;</button>
  ...
  var tourId;
   $(document).ready(function () 
   {
	   ...
	   $('#guest_email').keyup(function(){
		   $('.new_guest_email').html($(this).val());
	   }); 
	   $('#guest_whatsapp').keyup(function(){
		$('.new_guest_whatsapp').html($(this).val());
	   }); 
	   	// next page
...
<script>
var submitEvent=[],currentEvent,saveEvtObj={},offsetLeft=0,popoverElement='',$currentPopupDetailWrapper='',$currentPopoverToOpt='';
  $(function () {
				...
				eventRender: function (event, element,jsEvent) {
						...
						resouces.before("<a class='btn btn-sm btn-primary float-right open-modal'>Add Financial</a><span class='removeThisEvent'>&times;</span>").html('<span class="event_title" >'+ resouces.text() +'</span>');
							...
							element.find(".open-modal").on("click", function(e) {
								...
								var passenger= $('#passengers').val();
								var tour_id= tourId; 
								// alert("tour id :" +tour_id); 
								$('#financial-details').modal('show');
								addFinancialData(passenger, tour_id);
							});

							// $('#fCalendar').fullCalendar('renderEvent',element);
		...
		var objects2 = new Array();
		 for (let index = 0; index < eventsFromCalendar.length; index++) {
			 ...
			 // console.log(eventsFromCalendar[index].title)
			  ...
			  objects2[index]={title:eventsFromCalendar[index].title,
			  					end:eventsFromCalendar[index].end,
								start:eventsFromCalendar[index].start,
								allDay:eventsFromCalendar[index].allDay,
								backgroundColor:eventsFromCalendar[index].backgroundColor,
								borderColor:eventsFromCalendar[index].borderColor,
								_id:eventsFromCalendar[index]._id,
								className:eventsFromCalendar[index].className,
								_allDay:eventsFromCalendar[index]._allDay,
								_start:eventsFromCalendar[index]._start,
								_end:eventsFromCalendar[index]._end,
								eventDetails:eventsFromCalendar[index].evtData,
								external:eventsFromCalendar[index].financeData[0].external,
								internal:eventsFromCalendar[index].financeData[0].internal};
		 }
	...
	$.each(mainData, function(i, arrData){
		if(Array.isArray(arrData)){
			...
			$.each(arrData,function(i, thData){
				...
				if(thData == 'Action'){
					$theadTr.append(
						$('<th>',{'class': 'text-left', 'style': 'width: 200px'}).html('Car'),
...
// car changeMethod
function mySelectPicker($this) {
	// console.log('eee')
	// $($this).closest('tr').find('input[name="transportation_cost"]').val(
	// 	$($this).text()
	// )
	var adition = 0;
	$($this).find('option:selected').each(function(){
		adition += Number($(this).attr('data-tourcost'))
	});
	$($this).closest('tr').find('input[name="transportation_cost"]').val(adition);
...
function submitFinacialData(drop){
		var objTable = {},
			...
			if(drop){
			    ...
			    // console.log(mainArray, objTable,'=============')
