								...
								<div id="page-1">
									<table class="table table-striped table-bordered">
										...
										<tbody> 
											<tr> 
												<td scope="row">
													<input type="number" name="int_no_of_pax" class="form-control" placeholder="No of pax" />
												</td>  
												<td>
													<input type="text" name="int_supplier_value" class="form-control" placeholder="Value" />
												</td> 
												<td>
													<input type="number" name="int_extras_per_pax" class="form-control" placeholder="Extras Per Pax" />
												</td>
												<td>
													<input type="number" name="int_extras_per_car" class="form-control" placeholder="Extras Per Car" />
												</td>
												<td class="text-right">
								...
								<div id="page-2" class="hidden">
									<table class="table table-striped table-bordered">
										...
										<tbody> 
											<tr> 
												<td scope="row">
													<input type="number" name="ext_no_of_pax" class="form-control" placeholder="No of pax" />
												</td>  
												<td>
													<input type="text" name="ext_supplier_value" class="form-control" placeholder="Value" />
												</td> 
												<td>
													<input type="number" name="ext_extras_per_pax" class="form-control" placeholder="Extras Per Pax" />
												</td>
												<td>
													<input type="number" name="ext_extras_per_car" class="form-control" placeholder="Extras Per Car" />
												</td>
												<td class="text-right">
													<button class="btn btn-primary add-new-row"><i class="fa fa-plus"></i> Add Row</button>
												</td> 
		...
		$('body .add-supplier').on('click', function(e){
			...
			$('#financial-details table').each(function(i){
				...
				$(this).find('thead > tr').find('th').eq(index).after(
					...
					$('<th />').append(
						i == 0 ? 'Internal Supplier' : 'External Supplier' , + parseInt(count+Number(1)) ,' ',
				...
				$(this).find('thead > tr').find('th').eq(index).empty().append(
					i == 0 ? 'Internal Supplier' : 'External Supplier' , + count ,' ',
				...
				$(this).find('tbody > tr').each(function(){
					...
					$(this).find('td').eq(index).find('input').attr(
						'placeholder', 'value'+parseInt(count)
					)	
					...
					$(this).find('td').eq(index).after(
						$('<td />').append(
							...
							$('<input />',{
								...
								'class': 'form-control',
								'placeholder': 'value'+parseInt(count+Number(1))
							})
						)
						// $('#financial-details table').eq(0).find('tbody tr').eq(0).find('td').eq(index)
						// .clone(true)
					)
