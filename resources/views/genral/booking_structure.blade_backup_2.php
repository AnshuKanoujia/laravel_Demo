...
<script>
var currentEvent,saveEvtObj={},$currentPopupDetailWrapper='',$currentPopoverToOpt='',offsetLeft=0,popoverElement='',fcCalConfg='',renderingEvents='';
var popTemplate = [
    ...
    [
      {
        id: 101,
        resourceId: 'a',
        booking_id:"TOUR-03201211-1",
        customer_id: "11",
        start: "2020-03-16T03:30:00.000Z",
        end: "2020-03-16T12:30:00.000Z",
        resource:"sdas",
        driver:"1011",
        booking_type:"tour",
        status: 'completed',
        created_at:"2020-03-12 16:38:32",
        customers_id:1101,
        name:"shubham",
        email:"shubham@gmail.com",
        whatsapp:"532795826598",
        driver_id:1,
        driver_name:"akram",
        driver_email:"akram",
        driver_phone:"7658682529" 
      },
      {
        id: 102,
        resourceId: 'b',
        booking_id: "TOUR-03201211-1",
        customer_id: "11",
        start: "2020-03-16T06:30:00.000Z",
        end: "2020-03-16T12:30:00.000Z",
        resource: "sdas",
        driver: "1011",
        booking_type: "tour",
      ...
      },
      {
        ...
        booking_id:"TOUR-03201211-1",
        customer_id: "11",
        start: "2020-03-16T08:00:00+00:00",
        end: "",
        resource:"sdas",
        driver:"1011",
        booking_type:"tour",
    ...
    fcCalConfg={
      ...
      eventDrop: function(event) {
          ...
          $.ajax({
            type: 'POST',
            url: "{{url('update_booking_status')}}",
            data: {_token: "{{ csrf_token() }}",row_id: event.id,booking_id: event.booking_id,start_date: moment(event.start).format("YYYY-MM-DD HH:mm:ss"),end_date: moment(event.end).format("YYYY-MM-DD HH:mm:ss"),status: event.status,taxi: event.resourceId},
            success: function(resp){
              console.log(resp)
              setTimeout(function(){
                $('.fc-overlay').removeClass('active');
...
function gettingSettingEvents(newDate){
  ...
  //resourceVals=[{ id: 'a', title: 'Car 1' },{ id: 'b', title: 'Car 2' },{ id: 'c', title: 'Car 3' },{ id: 'd', title: 'Car 4' },{ id: 'e', title: 'Car 5' }];
  //var resourceVals=<?php if(isset($get_all_taxi)){ echo $get_all_taxi;  }else{ echo ''; } ?>;
  
  //allEvents=renderingEvents;
