                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            <div class="input-group ">
                              ...
                              <input type="text" class="form-control"  placeholder="Minutes" name="" required onkeypress="return isNumber(this, event)">
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row CurrencyTypeBox">
                          <div class="col">
                            <div class="form-group">
                              ...
                              <select class="form-control" onchange="updteCurrentType(event)">
                        ...
                        <div class="all_items_wrapper">
                          <div class="row">
                            <div class="col">
                              ...
                              <div class="form-group">
                                <input type="text" class="form-control"  placeholder="Component" name="" required>
                              </div>
                            </div>
                            <div class="col">
                              <div class="form-group">
                            ...
                            <div class="col">
                              ...
                              <div class="form-group">
                                <input type="text" class="form-control"  placeholder="Max pax" name="" required onkeypress="return isNumber(this, event)">
                              </div>
                            </div>
                            <div class="col">
                              <div class="form-group">
                            ...
                            <div class="col">
                              ...
                              <div class="form-group">
                                <div class="input-group ">
                                  ...
                                  <input type="text" class="form-control formatCurrency commission_input"  placeholder="Commission" name="" required onkeypress="return isNumber(this, event)">
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="row adder-row">
                            ...
                            <div class="col-sm-12 total-row text-right">
                              <div class="form-group form-inline">
                                ...
                                <input type="text" class="form-control totalCosts" required  id="gcTotalCosts" name="gcTotalCosts" placeholder="Total cost" readonly>
                              </div>
                              <div class="form-inline">
                                <label for="origin">Total Commission</label>
                                <input type="text" class="form-control totalCommission" required  id="gcTotalCommission" name="gcTotalCommission" placeholder="Total commission" readonly>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="all_items_wrapper">
                          ...
                          <div class="row adder-row">
                            ...
                            <div class="col-sm-12 total-row text-right">
                              <div class="form-group form-inline">
                                <label for="origin">Total Cost</label>
                                <input type="text" class="form-control totalCosts" required  id="pcTotalCosts" name="pcTotalCosts" placeholder="Total cost" readonly>
                              </div>
                              <div class="form-inline">
                                <label for="origin">Total Commission</label>
                                <input type="text" class="form-control totalCommission" required  id="pcTotalCommission" name="pcTotalCommission" placeholder="Total commission" readonly>
                              </div>
                            </div>
                          </div>
                        </div>
        ...
        element.popover({
          ...
          content: function(){
              ...
              var newPopover=$($("#popoverContent").html());
                  // newPopover.find(".text__editor").each(function(_, ckeditor) {
  ...
  $.ajax({
    ...
    success: function(resp){
      ...
      // console.log(resp.validate); 
       ...
       allEvents=[{"id": 20 ,"booking_id": "TOUR-03202012-6","customer_id": "20","start": "2020-03-28T10:00:00Z","end": "2020-03-28T19:00:00Z","resource": "sfdf","resourceId": "1","driver": "1","booking_type": "tour","status": "completed","created_at": "2020-03-28 17:45:12","customers_id": 20 ,"name": "Ravi","email": "Ravi@gmail.com","whatsapp": "486399584358","driver_id": 1, "driver_name": "Akram","driver_email": "Akram@augurs.in","driver_phone": "7658682529"}, {"id": 40 ,"booking_id": "TOUR-03202012-6","customer_id": "21","start": "2020-03-28T08:00:00Z","end": "2020-03-28T09:00:00Z","resource": "sfdf","resourceId": "3","driver": "1","booking_type": "tour","status": "completed","created_at": "2020-03-28 17:45:12","customers_id": 21 ,"name": "Ravi","email": "Ravi@gmail.com","whatsapp": "486399584358","driver_id": 1 ,"driver_name": "Akram","driver_email": "Akram@augurs.in","driver_phone": "7658682529"}, {"id": 60 ,"booking_id": "TOUR-03202012-6","customer_id": "21","start": "2020-03-28T12:00:00Z","end": "2020-03-28T21:00:00Z","resource": "sfdf","resourceId": "2","driver": "1","booking_type": "tour","status": "completed","created_at": "2020-03-28 17:45:12","customers_id": 21 ,"name": "Ravi","email": "Ravi@gmail.com","whatsapp": "486399584358","driver_id": 1, "driver_name": "Akram","driver_email": "Akram@augurs.in","driver_phone": "7658682529"} ];
       console.log(allEvents)
       if(resourceVals && allEvents){ updateCalConfig(defDate,resourceVals,allEvents,setOld); }
...
.on('click','.btn-next',function(e){
  ...
  if($nextTab.hasClass('calendar_view')){
      // setTimeout(function(){
        $('.fc-overlay').addClass('active');
        var defDate=moment().format();
        gettingSettingEvents(defDate,false); 
