                      ...
                      <div class="box-body clearfix">
                        <div class="col-sm-6 col-md-4 col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="hidden" name="activity_type" id="activity_type" value="{{$get_tour_type_row->id?$get_tour_type_row->id:'5'}}">
                          ...
                          <div class="bootstrap-timepicker">
                            <div class="form-group bootstrap-timepicker">
                              <label for="end_time">Approx End Time</label> 
                               <input type="text" class="form-control" required id="end_time" value="{{$tour_template->end_time}}"  name="end_time" placeholder="End Time">
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3">
                          ...
                          <div class="col">
                            <div class="form-group">
                              ...
                              <select name="groupCurrencyType"  class="form-control" onchange="updteCurrentType(event)">
                                ...
                                <option value="IDR" @if($tour_template->group_currency=='IDR') selected @endif>IDR</option>
                                <option value="INR" @if($tour_template->group_currency=='INR') selected @endif>INR</option>
                                <option value="EUR" @if($tour_template->group_currency=='EUR') selected @endif >EUR</option>
                                <option value="USD" @if($tour_template->group_currency=='USD') selected @endif>USD</option>
                              </select>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="all_items_wrapper">
                          <div class="row">
                            <div class="col">
                              ...
                              @foreach(json_decode($tour_template->group_costs) as  $row)
                              <div class="form-group">
                                <input type="text" class="form-control arr-item" value="{{$row->group_component}}"  placeholder="Component" name="groupComponent[]" required>
                              </div>
                              @endforeach
                            </div>
                            <div class="col">
                              ...
                              <div class="form-group">
                                <div class="input-group ">
                                  ...
                                  <input type="text" class="form-control formatCurrency cost_input arr-item" value="{{$row->group_cost}}"  placeholder="Cost" name="groupCost[]" required  onkeypress="return isNumber(this, event)">
                                </div>
                              </div>
                              @endforeach
                            </div>
                            <div class="col">
                              ...
                              @foreach(json_decode($tour_template->group_costs) as  $row)
                              <div class="form-group">
                                <input type="text" class="form-control arr-item" value="{{$row->group_maxpax}}"  placeholder="Max pax" name="groupMaxPax[]" required onkeypress="return isNumber(this, event)">
                              </div>
                              @endforeach
                            </div>
                            <div class="col">
                              ...
                              @foreach(json_decode($tour_template->group_costs) as  $row)
                              <div class="form-group">
                                <input type="text" class="form-control arr-item" value="{{$row->group_beneficiary}}" placeholder="Beneficiary" name="groupBeneficiary[]" required>
                              </div>
                              @endforeach
                            </div>
                            <div class="col">
                              ...
                              <div class="form-group">
                                <div class="input-group ">
                                  ...
                                  <input type="text" class="form-control formatCurrency commission_input arr-item" value="{{$row->group_commission}}" placeholder="Commission" name="groupCommission[]" required onkeypress="return isNumber(this, event)">
                                </div>
                              </div>
                              @endforeach
                            </div>
                          ...
                          <div class="row adder-row">
                            ...
                            <div class="col-sm-12 total-row text-right">
                              <div class="form-group form-inline">
                                ...
                                <input type="text" class="form-control totalCosts" value="{{$tour_template->group_TotalCosts}}" required  id="totalGroupCost" name="totalGroupCost" placeholder="Total cost" readonly>
                              </div>
                              <div class="form-inline">
                                <label for="origin">Total Commission</label>
                                <input type="text" class="form-control totalCommission" required value="{{$tour_template->group_TotalCommission}}" id="totalGroupCommission" name="totalGroupCommission" placeholder="Total commission" readonly>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col">
                            <div class="form-group">
                              ...
                              <select class="form-control" onchange="updteCurrentType(event)" name="paxCurrrencyType">
                                <option value="">Select Currency</option>
                                <option value="IDR" @if($tour_template->pax_currency=='IDR') selected @endif >IDR</option>
                                <option value="INR" @if($tour_template->pax_currency=='INR') selected @endif >INR</option>
                                <option value="EUR" @if($tour_template->pax_currency=='EUR') selected @endif >EUR</option>
                                <option value="USD" @if($tour_template->pax_currency=='USD') selected @endif >USD</option>
                              </select>
                            </div>
                          </div>
                        </div>
                        <div class="all_items_wrapper">
                          <div class="row">
                            <div class="col">
                              ...
                              @foreach(json_decode($tour_template->pax_costs) as  $row)
                              <div class="form-group">
                                <input type="text" class="form-control arr-item"  placeholder="Component" value="{{$row->pax_component}}" name="paxComponent[]" required>
                              </div>
                              @endforeach
                            </div>
                            <div class="col">
                              ...
                              <div class="form-group">
                                <div class="input-group ">
                                  ...
                                  <input type="text" class="form-control formatCurrency cost_input arr-item" value="{{$row->pax_cost}}"  placeholder="Cost" name="paxCost[]" required  onkeypress="return isNumber(this, event)">
                                </div>
                              </div>
                              @endforeach
                            </div>
                            <div class="col">
                              ...
                              @foreach(json_decode($tour_template->pax_costs) as  $row)
                              <div class="form-group">
                                <input type="text" class="form-control arr-item"  placeholder="Max pax" value="{{$row->pax_min_age}}" name="paxMinAge[]" required onkeypress="return isNumber(this, event)">
                              </div>
                              @endforeach
                            </div>
                            <div class="col">
                              ...
                              @foreach(json_decode($tour_template->pax_costs) as  $row)
                              <div class="form-group">
                                <input type="text" class="form-control arr-item" value="{{$row->pax_beneficiary}}"  placeholder="Beneficiary" name="paxBeneficiary[]" required>
                              </div>
                              @endforeach
                            </div>
                            <div class="col">
                              ...
                              <div class="form-group">
                                <div class="input-group ">
                                  ...
                                  <input type="text" class="form-control  formatCurrency commission_input arr-item" value="{{$row->pax_commission}}" placeholder="Commission" name="paxCommission[]" required onkeypress="return isNumber(this, event)">
                                </div>
                              </div>
                              @endforeach
                            </div>
                          ...
                          <div class="row adder-row">
                            ...
                            <div class="col-sm-12 total-row text-right">
                              <div class="form-group form-inline">
                                <label for="origin">Total Cost</label>
                                <input type="text" class="form-control totalCosts" required value="{{$tour_template->pax_TotalCosts}}"  id="totalPaxCosts" name="totalPaxCosts" placeholder="Total cost" readonly>
                              </div>
                              <div class="form-inline">
                                <label for="origin">Total Commission</label>
                                <input type="text" class="form-control totalCommission" value="{{$tour_template->pax_TotalCommission }}" required  id="totalPaxCommission" name="totalPaxCommission" placeholder="Total commission" readonly>
                              </div>
                            </div>
                          </div>
                        </div>
...
<div class="modal fade" id="add_financial_info" role="dialog">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title">Financial Info  Details</h4>
         </div>
          <form id="update_finanencial_form" action="{{url('update_finanencial')}}" method="post" onsubmit="return confirm('Do you  want to save this  Details ?');">
          {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <td>
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" required=""  onkeypress="return isNumber(this, event)"  id="no_of_pax" name="no_of_pax" placeholder="Number Of Pax">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                          <label for="supplier_cost">Supplier cost</label>
                          <input type="text" class="form-control" required=""  onkeypress="return isNumber(this, event)"  id="supplier_cost" name="supplier_cost" placeholder="Supplier cost">
                        </div>
                    </td>
                    <td>
                        <label for="suppliers">Suppliers <i style="color:red;">*</i> </label>
                        <span class=" tgInptW" style="width:20px;">
                          <input type="text"   id="suppliers_name" name="suppliers_name[]" placeholder="suppliers Name">
                        </span>
                         
                        <span class=" tgInptW"  style="width:20px;" >
                          <input type="text"    id="suppliers_value " name="suppliers_value[]" placeholder="suppliers value">
                        </span>
                       <br/>
                        <span class=" tgInptW" style="width:20px;">
                          <input type="text"  id="suppliers_name " name="suppliers_name[]" placeholder="suppliers name">
                    ...
                    <td>
                       <div class="form-group">
                          <label for="cost_to_client">Cost To Client (Pax)</label>
                          <input type="text" class="form-control" required="" onkeypress="return isNumber(this, event)"   id="cost_to_client" name="cost_to_client" placeholder="Cost To Client (Pax)">
                        </div>
                    </td>
                    <td>
                       <div class="form-group">
                          <label for="extras_per_car">Extras Per Car</label>
                          <input type="text" class="form-control" required="" onkeypress="return isNumber(this, event)"  id="extras_per_car" name="extras_per_car" placeholder="Extras Per Car">
                        </div>
                    </td>
                    </tbody>
                    </table>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-success saveDropEvt">
            <span class="fa fa-spiner"></span>
          Save changes</button>
      </div>
      </form>
      </div>
