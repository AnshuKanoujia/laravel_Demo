                  ...
                  <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" onkeypress="return restrictNumerics(event);"  maxlength="30"  required id="name" name="name" placeholder="Name..">
                            </div>

                            <div class="form-group">
                              <label for="phone">Phone</label>
                              <input type="text" class="form-control" maxlength="12" onkeypress="return restrictAlphabets(event);" id="phone"  required name="phone" placeholder="Phone">
                            </div>
         ...
         <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">All driver List</h3> <div class="pull-right alertmessage"></div>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                     @foreach($all_drivers as $value)
                      <tr id="row_{{$value->id}}">
                        <td><a href="{{url('driver-details/'.$value->id)}}"><img  src="{{ URL::asset('images/'.$value->image)}}" style="height:30px; width:30px; border-radius:50%;  " />
                        &nbsp;&nbsp;{{$value->name}} </a></td>
                        <td>{{$value->email}}</td>
                        <td>{{$value->phone}}</td>
                        <td>{{$value->address}}</td>
  ...
  function initialize(){
    ...
    geocoder.geocode({'latLng': marker.getPosition()}, function(results, status) {
      ...
      $(function () {
        ...
        var pickerOptsGeneral = { format: "yyyy-mm-dd", autoclose: true, minView: 2, maxView: 2, todayHighlight: true,endDate:  new Date() };
