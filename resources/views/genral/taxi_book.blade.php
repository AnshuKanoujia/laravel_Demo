         ...
         <div class="col-md-9">
            ...
            <div class="box box-success">
               <div class="box-header">
                  <?php $action='add_booking_taxi'; ?><!-- javascript:void(0)  id="bookingform" -->
                     ...
                     <div class="box-body">
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" required  maxlength="50" onkeypress="return restrictNumerics(event);" id="guest_name"  name="guest_name" placeholder="Guest Name">
                           </div>
                        ...
                        <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                <div class="bootstrap-timepicker">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="5" required  id="children_below" onkeypress="return restrictAlphabets(event);  " name="children_below" placeholder="Children ">
                                 </div>
                              </div>
                              <div class="col-md-6">
                               <div class="bootstrap-timepicker">
                                    <div class="form-group bootstrap-timepicker">
                                       <label for="driver_approx_time">Driver Approx Time</label> 
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" maxlength="20" required  id="taxi_cost" onkeypress="return restrictAlphabets(event);  " name="taxi_cost" placeholder="Taxi Cost">
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <datalist id="custom_address"> 
                                 @if(count($booking_deatils['get_all_address']) > 0 )
                                    @foreach($booking_deatils['get_all_address'] as $value)
                        ...
                        <button type="submit" class="btn btn-primary next-step pull-right">Book Now</button>
