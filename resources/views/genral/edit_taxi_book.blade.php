                     ...
                     <div class="box-body">
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" onkeypress="return restrictNumerics(event);" required value="{{$booking_deatils->guest_name}}"  maxlength="50" id="guest_name"  name="guest_name" placeholder="Guest Name">
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" maxlength="12" value="{{$booking_deatils->guest_whatsapp}}" onkeypress="return restrictAlphabets(event);" required id="guest_whatsapp"  name="guest_whatsapp" placeholder="Guest Whatsapp">
                           </div>
                         
                           <div class="form-group">
                              <label for="special_request">Special Request</label>
                              <textarea class="form-control" name="special_request"   style="resize:none;" rows="2"      id="special_request"  placeholder="Special Request ...">{{$booking_deatils->special_request}}</textarea>
                           </div>
                              ...
                              <div class="col-md-6">
                               <div class="bootstrap-timepicker">
                                    <div class="form-group bootstrap-timepicker">
                                       ...
                                       <input type="text" class="form-control driver_approx_time" value="{{$booking_deatils->tour_approx_end_time}}" required id="driver_approx_time"   name="driver_approx_time" placeholder="Driver Approx Time">
                                    </div>
                                 </div>
                                 <div class="form-group">
   ...
   <div class="modal-dialog modal-sm">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <p class="text-center">If You want to change date <a href="{{url('dashboard')}}">go back</a> to date selection page</p>
         </div>
      </div>
   </div>
</div>
