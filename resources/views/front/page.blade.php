  ...
  <div class="container">
    ...
    <div class="row"> 
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="why-onn-item">
          <p class="text-heading-whyonn">Safety</p>
          <div class="sprite sprite-racing-helmet sprite-icon-more"></div>
          <div class="why-onn-item-title">
            <p class="text-center">Your safety is our priority. We guarantee a comprehensive insurance and also an ISI marked helmet. With all new bikes and a strict maintenance policy, you can keep calm and ride ONN!</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="why-onn-item">
          <p class="text-heading-whyonn">Pit stops</p>
          <div class="sprite sprite-white-map-locator sprite-icon-more"></div>
          <div class="why-onn-item-title">
            <p class="text-center">We have ‘ONN Bike Rental Hubs’ in different parts of the city, so you’d never go 'OffBikes'. Reach out to us from wherever you are and we’ll fix you right up!</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="why-onn-item">
          <p class="text-heading-whyonn">Wallet’s BFF</p>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="why-onn-item">
          <p class="text-heading-whyonn">One stop shop</p>
...
<section ng-hide="hideAll" id="whyonn" class="bg-grey section">
  <div class="why-onn">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
      ...
      <div class="row">
        <div class="introducing-looking-faq col-md-6 visible-md visible-lg">
          <div class="why-onn-item-title-faq">
        ...
        <div class="introducing-looking-faq col-md-6 visible-md visible-lg">
          <div class="why-onn-item-title-faq">
            <p class="text-left"><span class="introducing-looking-faq-heading"><i class="fa fa-circle" aria-hidden="true"></i> What documents do I need to show while booking?</span><br>
              ...
              ONN Bikes provides one helmet with each booking. The second helmet is provided, if needed and is subject to availability.<br>
              <br>
            </p>
          </div>
        </div>
        ...
        <article class="text-center faq-bottom-text ng-scope" ng-if="phonePePlatform == false">If you have any more doubts, please visit our <a href="https://www.onnbikes.com/faq.html" target="_blank">FAQ Section</a><br>
          Our Daily Bike Renting Plan is the most affordable plan in India. Check out our Fleet and Pricing section on top for more detailed information and if you are a bike enthusiast, check out our <a href="https://blog.onnbikes.com/" target="_blank">Blog</a>.
          <p></p>
        </article>
